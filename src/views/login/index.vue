<template>
    <div class="login-main">
        <div class="login-head">
            <svg class="login-head-left" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <div v-else class="login-body">
            ...
            <div class="login-body-text">使用
                <span class="login-body-text-span">网易云音乐APP</span>扫码登录
            </div>
        </div>
...
const condition = (res) => {
    messageCode.value = res.code;
    return res.code === 800 || res.code === 803;
}
